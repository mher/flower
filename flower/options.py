...
define("oauth2_key", type=str, default=None, help="OAuth2 key (requires --auth)")
define("oauth2_secret", type=str, default=None, help="OAuth2 secret (requires --auth)")
define(
    "oauth2_redirect_uri",
    type=str,
    default=None,
...
define("ca_certs", type=str, default=None, help="SSL certificate authority (CA) file")
...
define("natural_time", type=bool, default=False, help="show time in relative format")
define(
    "tasks_columns",
    type=str,
