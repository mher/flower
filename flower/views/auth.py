...
class OktaLoginHandler(BaseHandler, tornado.auth.OAuth2Mixin):
    ...
    _OAUTH_AUTHORIZE_URL = "https://{okta_subdomain}/oauth2/v1/authorize"
    _OAUTH_ACCESS_TOKEN_URL = "https://{okta_subdomain}/oauth2/v1/token"
    _OAUTH_USER_INFO_URL = "https://{okta_subdomain}/oauth2/v1/userinfo"
    _OAUTH_NO_CALLBACKS = False
    _OAUTH_SETTINGS_KEY = 'oauth'
