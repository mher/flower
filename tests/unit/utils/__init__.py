...
def task_succeeded_events(
    worker, id=None, name=None, runtime=0.1234, retries=0, eta=None
):
    id = id or uuid()
    ...
    return [
        ...
        Event("task-succeeded", uuid=id, result="4", runtime=runtime, hostname=worker),
    ]
