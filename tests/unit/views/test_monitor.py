...
class PrometheusTests(AsyncHTTPTestCase):
    ...
    def test_task_prefetch_time_metric(self):
        ...
        self.assertTrue(
            f'flower_task_prefetch_time_seconds{{task="{task_name}",worker="{worker_name}"}} 3.0'
            in metrics
        )
    ...
    def test_task_prefetch_time_metric_successful_task_resets_metric_to_zero(self):
        ...
        self.assertTrue(
            f'flower_task_prefetch_time_seconds{{task="{task_name}",worker="{worker_name}"}} 0.0'
            in metrics
        )
    ...
    def test_task_prefetch_time_metric_does_not_compute_prefetch_time_if_task_has_eta(
        self,
    ):
        state = EventsState()
        worker_name = "worker2"
        ...
        self.assertFalse(
            f'flower_task_prefetch_time_seconds{{task="{task_name}",worker="{worker_name}"}} '
            in metrics
        )
