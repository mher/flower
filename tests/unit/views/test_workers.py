...
class WorkersTests(AsyncHTTPTestCase):
    ...
    def test_single_workers_offline(self):
        ...
        state.event(
            Event("worker-online", hostname="worker1", local_received=time.time())
        )
        state.event(
            Event("worker-offline", hostname="worker1", local_received=time.time())
        )
    ...
    def test_single_workers_online(self):
        ...
        self.assertTrue(table.get_row("worker1"))
        self.assertEqual(
            ["worker1", "True", "0", "0", "0", "0", "0", None], table.get_row("worker1")
        )
        self.assertFalse(table.get_row("worker2"))
    ...
    def test_task_received(self):
        ...
        self.assertEqual(
            ["worker1", "True", "0", "1", "0", "0", "0", None], table.get_row("worker1")
        )
        self.assertEqual(
            ["worker2", "True", "0", "0", "0", "0", "0", None], table.get_row("worker2")
        )
    ...
    def test_task_succeeded(self):
        ...
        self.assertEqual(
            ["worker1", "True", "0", "1", "0", "1", "0", None], table.get_row("worker1")
        )
        self.assertEqual(
            ["worker2", "True", "0", "0", "0", "0", "0", None], table.get_row("worker2")
        )
    ...
    def test_task_failed(self):
        ...
        self.assertEqual(
            ["worker1", "True", "0", "1", "1", "0", "0", None], table.get_row("worker1")
        )
        self.assertEqual(
            ["worker2", "True", "0", "0", "0", "0", "0", None], table.get_row("worker2")
        )
    ...
    def test_task_retried(self):
        ...
        self.assertEqual(
            ["worker1", "True", "0", "1", "1", "0", "1", None], table.get_row("worker1")
        )
        self.assertEqual(
            ["worker2", "True", "0", "0", "0", "0", "0", None], table.get_row("worker2")
        )
    ...
    def test_tasks(self):
        ...
        self.assertEqual(
            ["worker3", "True", "0", "23", "13", "10", "0", None],
    ...
    def test_workers_page(self):
        ...
        self.app.inspector.workers["worker1"] = {
            ...
            "active_queues": [],
            "stats": {
                "total": {"tasks.add": 10, "tasks.sleep": 1, "tasks.error": 1},
                "broker": {
                    "hostname": "redis",
                    "userid": None,
                    "virtual_host": "/",
